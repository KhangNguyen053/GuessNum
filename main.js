...
const lbLive= document.getElementById("lbLive");
...
introCard.onclick = () => {
  new Audio("./assets/newgame.mp3").play();
...
btGuess.onclick = () => {
  ...
  if (guess === mysteryNumber) {
    ...
    lbResultOnWin.innerHTML = `The code was ${mysteryNumber}`;

    new Audio("./assets/right.mp3").play();
  ...
  if (live === 0) {
    ...
    lbResultOnOver.innerHTML = `The code was ${mysteryNumber}`;
    new Audio("./assets/lose.mp3").play();
  }
  lbLive.innerText ="Remaining Live:"+live;
